...
class Experiment_stochastic():
    ...
    def run_Jacquelines_experiment(self, population):
        ...
        while cycle_counter<40:  # should be 40 in normal simulations
    ...
    def OLDrun_Jacquelines_experiment(self, population):
        
        cycle_counter=0
        conc_increase_counter=0
        
        while conc_increase_counter<len(self.concentration_gradient) and cycle_counter<40:
